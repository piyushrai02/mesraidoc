...
<Callout type="info">
Get your API key from the [Mesrai Dashboard](https://app.mesrai.com/settings/api) under Settings → API Keys.
</Callout>
...
- 💬 Discord: [Join our community](https://discord.gg/mesrai)
