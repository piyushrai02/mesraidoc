...
description: "Set up Mesrai Rules focused on OWASP top 10, secrets detection, and secure coding patterns."
icon: "shield-halved"
---
...
For more on configuring rules, see [Mesrai Rules](/guides/code_review/configs/mesrai_rules).
