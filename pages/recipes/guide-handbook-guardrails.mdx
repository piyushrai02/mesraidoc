...
description: "Convert your engineering handbook into living Mesrai Rules with optional MCP plugins."
icon: "shield-check"
---
...
- [Mesrai Rules](/guides/code_review/configs/mesrai_rules) – encode each policy bullet as deterministic file-level or PR-level checks.
...
- You have permission to edit **Code Review Settings → Mesrai Rules**.
...
## Phase 3 – Translate sections into Mesrai Rules

Open **Code Review Settings → Mesrai Rules** and map each policy section to the appropriate scope.
...
<Info>
  Rules already understand variables (`fileDiff`, `pr_files_diff`, etc.), file references, and MCP invocations. See the full matrix in the [Mesrai Rules guide](/guides/code_review/configs/mesrai_rules).
</Info>
...
- [ ] File-level and PR-level Mesrai Rules cover your critical sections.
