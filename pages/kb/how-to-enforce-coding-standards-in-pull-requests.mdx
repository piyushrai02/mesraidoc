...
Mesrai lets you define **Mesrai Playbook** — custom instructions that are checked automatically during every code review. There are two types:
...
For more details, see the [Mesrai Playbook documentation](/guides/code_review/configs/mesrai_rules).
