...
1. Go to **Code Review Settings** → **Prompt Studio**
...
4. Add **Prompt Studio** for domain-specific knowledge

For details, see [Prompt Studio](/guides/code_review/configs/custom_prompts) and [Plugins](/guides/code_review/plugins).
