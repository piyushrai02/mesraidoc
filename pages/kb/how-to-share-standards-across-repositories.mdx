...
1. Go to **Code Review Settings** → **Global** → **Mesrai Playbook**
...
```
@mesrai remember: across all repos, we use ESLint flat config format.
```

For details, see [Rules Inheritance](/guides/code_review/configs/rules_inheritance).
