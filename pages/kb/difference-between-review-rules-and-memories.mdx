...
In the Mesrai Rules UI, you configure two different things, and knowing when to use each one makes your code reviews more effective.
...
For details, see [Mesrai Rules](/guides/code_review/configs/mesrai_rules).
