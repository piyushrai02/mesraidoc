...
description: "Create a GitHub OAuth App for Sign-in-with-GitHub in self-hosted Mesrai deployments."
icon: github
---
...
Use this if you want users to sign in to Mesrai with GitHub. This is separate from the GitHub App integration used for code review automation and webhooks.
...
After creating the app, copy the credentials from GitHub and add them to your Mesrai environment:
