...
description: "Create a GitLab OAuth application for Sign-in-with-GitLab in self-hosted Mesrai deployments."
icon: gitlab
---
...
Use this if you want users to sign in to Mesrai with GitLab. This is separate from the GitLab webhook integration used for code review automation.
...
After creating the app, copy the credentials from GitLab and add them to your Mesrai environment:
