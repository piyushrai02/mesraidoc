# Configurando o Atlassian Rovo MCP Server com a Mesrai

Guia passo a passo para conectar o Atlassian Rovo MCP (Jira, Confluence) via OAuth 2.1 na plataforma Mesrai.
...
O admin da organizacao precisa liberar o redirect URI da Mesrai no servidor Rovo MCP.

1. Acesse [admin.atlassian.com](https://admin.atlassian.com)
2. Selecione sua organizacao (ex: `your-org`)
...
```
https://app.yourdomain.com/setup/mcp/oauth
```
...
**Causa:** O redirect URI da Mesrai nao esta cadastrado no Rovo MCP server.

**Solucao:**

1. Acesse [admin.atlassian.com](https://admin.atlassian.com) > **Rovo** > **Servidor MCP do Rovo**
2. Adicione `https://app.yourdomain.com/setup/mcp/oauth` na lista de dominios
