...
<Tip>For full multi-agent bootstrap, prefer the platform installer (`curl -fsSL https://review-skill.com/install | bash`). `mesrai skills` covers local re-sync and cleanup.</Tip>
