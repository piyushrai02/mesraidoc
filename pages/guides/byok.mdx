...
description: "Connect your own LLM provider account. Mesrai never marks up tokens, never logs your key, and never sees billing data."
---
...
Bring Your Own Key is how Mesrai uses LLMs by default on every plan — Free Trial, Pro, and Enterprise. You connect your own provider account, choose any compatible model, and the token bill lands on your provider's dashboard, not ours. Mesrai never adds a margin to tokens and never stores your key in plain text.

<Card
  title="How this maps to plans"
  icon="scale-balanced"
  href="/guides/pricing#ai-included-vs-byok"
>
  BYOK is unlimited during the 14-day Free Trial, ₹499 / $6 per active dev / month on Pro (unlimited reviews), and one of two modes on Enterprise (the other being AI Included with a Mesrai-managed model).
</Card>
...
<Steps>
  <Step title="Open BYOK Settings">
    Go to [app.mesrai.com/organization/byok](https://app.mesrai.com/organization/byok).
  </Step>
...
<Tabs>
  ...
  <Tab title="Kimi K2.6 (Moonshot AI)">
    ...
    <Info>
      Kimi Code Plan is documented at a cap of 30 concurrent requests. Mesrai pre-fills `maxConcurrentRequests=30` when you pick that plan.
    </Info>
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Novita AI">
    ...
    **Get an API key:**
    ...
    <Card title="Novita Setup Guide" icon="rocket" href="/recipes/novita">
  ...
  <Tab title="OpenAI Compatible">
    ...
    **How to configure:**
    ...
    <CardGroup cols={2}>
      <Card title="Z.ai (GLM) guide" href="/kb/how-to-use-z-ai-with-mesrai" icon="bolt">
        Full Z.ai setup with Coding Plan details.
      </Card>
      <Card title="Moonshot (Kimi) guide" href="/kb/how-to-use-moonshot-with-mesrai" icon="moon">
        Kimi K2.6 + Kimi Code Plan setup.
      </Card>
      <Card title="Fireworks AI" href="/kb/how-to-use-fireworks-with-mesrai" icon="fire">
        Fireworks-specific setup.
      </Card>
      <Card title="Together AI" href="/kb/how-to-use-together-ai-with-mesrai" icon="handshake">
        Together AI setup.
      </Card>
    </CardGroup>
  </Tab>
...
| **Anthropic / OpenAI / Google / OpenRouter** | _(empty)_ | Providers enforce their own TPM/RPM; Mesrai doesn't cap. |
