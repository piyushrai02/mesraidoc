...
>
  BYOK is unlimited during the 14-day Free Trial, ₹499 / active dev / month on Pro (unlimited reviews), and one of two modes on Enterprise (the other being AI Included with a Mesrai-managed model).
</Card>
