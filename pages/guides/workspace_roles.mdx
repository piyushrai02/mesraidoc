...
description: "Learn about role-based access control (RBAC) in Mesrai workspaces, including the different user roles and their permissions."
---
...
- **Workspace Members**: Admins who configure Mesrai settings (unlimited)
- **PR Licenses**: Developers from your Git organization who get Mesrai reviews (based on your plan)
</Note>
...
**Why isn't a developer showing up?** If a developer isn't appearing in your PR license count, it means Mesrai isn't installed in a repository where that developer has opened PRs.
...
Mesrai workspaces supports **Role-Based Access Control (RBAC)**, allowing you to manage user permissions and access levels within your organization. Each workspace member can be assigned one of four distinct roles, each with specific permissions and capabilities.
...
**Repository management** access focused on managing code review configurations for repositories they own, with full access to issues, Pulse, and plugins.
...
**How to enable:**
1. Go to [Organization Settings](https://app.mesrai.com/organization/general)
...
<AccordionGroup>
  ...
  <Accordion title="A member can't access Pulse features">
    **Solutions:**
  ...
  <Accordion title="A developer isn't showing up in PR licenses">
    **Solutions:**
    - Verify Mesrai is installed in the repositories where this developer opens PRs
