...
description: "Create a GitHub Fine-Grained Personal Access Token (FGPAT) for Mesrai code review access."
---
...
1. Under **Fine-Grained Personal Access Tokens**, select **"Allow access via fine-grained personal access tokens"** to enable secure access for Mesrai.
