---
title: "Plugins"
description: "Plugins are a way to bring external business context directly into Mesrai's review workflow."
tag: 'beta'
---
...
- `@mesrai, update this mesrai rule to ignore test files`
- `@mesrai, move this task https://jira.com/task-123 to DONE`
...
<Card title="Business Logic Validation Guide" icon="shield-check" href="/guides/code_review/business_logic_validation">
...
3. Click **Create Plugin** to instantly make it available to Mesrai within the current workspace.
