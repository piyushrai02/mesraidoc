---
title: "Overview"
description: "Mesrai Rules are customizable guidelines your team sets up to automatically enforce code quality, consistency, security, and maintainability."
---
...
## Two Types in the Mesrai Rules UI

Mesrai Rules are organized into two categories, managed through a tabbed interface in your settings:
...
1. Go to **Code Review Settings** → **Repository** → **Mesrai Rules**
...
1. Go to **Code Review Settings** → **Repository** → **Mesrai Rules** → **Memories** tab
