...
By default, Mesrai Playbook are inherited down the hierarchy:
...
- <a href="/guides/code_review/configs/mesrai_rules">Mesrai Playbook Overview</a>
- <a href="/guides/code_review/configs/directory_level">Directory-Level Settings</a>
- <a href="/guides/code_review/configs/inheritance_overrides">Config Inheritance & Overrides</a>
- <a href="/guides/code_review/configs/centralized_config">Centralized Config</a> — manage rules as YAML files under `.mesrai-rules/` in a single repository.
