...
description: "Manage all code review configuration and Mesrai Rules as code in a single repository. Changes sync automatically after each merge; rollout is controlled from the UI or the CLI."
---
...
See [Mesrai Rules Overview](/guides/code_review/configs/mesrai_rules) for the full field reference and [Rule Inheritance](/guides/code_review/configs/rules_inheritance) for how `inheritance.inheritable`, `exclude`, and `include` behave.
...
- [Mesrai Rules Overview](/guides/code_review/configs/mesrai_rules)
