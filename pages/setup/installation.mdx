...
<Callout type="info">
  **Privacy Note:** Mesrai never stores your source code. All analysis happens
  in memory and is deleted immediately after review.
</Callout>
...
<Callout type="info">
  For this guide, we'll choose **Connect Repositories** for the fastest setup.
  Click the **Connect Repositories** button.
</Callout>
...
<Callout type="info">
  Click **Sync Repositories** if you don't see all your repos immediately — this
...
- **Discord:** [discord.gg/mesrai](https://discordapp.com/users/1436265373757341699)
