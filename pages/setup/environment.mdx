...
description: Configure your development environment to work with Mesrai for local testing and CI/CD integration. Prerequisites, Node.js, Git, and environment variable setup.
---
...
All configuration is done through the [Mesrai Dashboard](https://app.mesrai.com):
...
- [Join Discord](https://discordapp.com/users/1436265373757341699)
