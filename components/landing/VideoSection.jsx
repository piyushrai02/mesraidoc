    ...
    <section className="py-20 px-6 bg-white dark:bg-[#09090B]">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#E8772E]/10 text-[#E8772E] text-xs font-semibold tracking-wide uppercase mb-4">
        ...
        <div className="relative rounded-2xl overflow-hidden border border-gray-200 dark:border-[#27272A] shadow-2xl dark:shadow-[0_25px_60px_rgba(0,0,0,0.5)]">
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-[#E8772E]/20 via-[#F0944D]/10 to-[#E8772E]/20 rounded-2xl blur-xl opacity-0 dark:opacity-50 -z-10" />
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 text-sm">
          <a
            ...
            className="group inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-[#E8772E] dark:hover:text-[#F0944D] transition-colors font-medium"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
