...
export const CommunityCard = () => {
  return (
    <div className="p-8 rounded-2xl bg-white dark:bg-[#141517] border border-gray-200 dark:border-[#27272A]">
      {/* Discord icon */}
      <div className="w-12 h-12 rounded-lg bg-[#FF6B35]/10 dark:bg-[#FF6B35]/15 flex items-center justify-center mb-4">
        <svg className="w-6 h-6" style={{ color: '#FF6B35' }} fill="currentColor" viewBox="0 0 24 24">
      ...
      <a
        ...
        onMouseEnter={e => {
          ...
          e.currentTarget.style.boxShadow = '0 6px 24px rgba(255,107,53,0.35)';
        }}
        onMouseLeave={e => {
