 ...
 * - Theme-aware styling
 * - Social media links
 * - "Built with React & Tailwind" text
 */
...
export const Footer = () => {
  return (
    <footer className="bg-gray-50 dark:bg-[#0F0F12] border-t border-gray-200 dark:border-[#27272A]">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <FooterSection title="Company">
            <FooterLink href="https://mesrai.com/about" external>About</FooterLink>
            <FooterLink href="https://mesrai.com/blog" external>Blog</FooterLink>
            {/* <FooterLink href="https://mesrai.com/careers" external>Careers</FooterLink> */}
            <FooterLink href="https://mesrai.com/contact" external>Contact</FooterLink>
          </FooterSection>
        ...
        {/* Bottom section */}
        <div className="border-t border-gray-200 dark:border-[#27272A] pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            {/* Copyright and built with */}
            <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4 text-sm text-gray-500 dark:text-gray-500">
              <span>&copy; {new Date().getFullYear()} Mesrai. All rights reserved.</span>
              <span className="hidden md:inline">•</span>
              <span>Signal Driven Code Review</span>
            </div>

            {/* Social Links */}
            <div className="flex items-center gap-6">
              <SocialLink href="https://x.com/mesraiofficial" label="Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </SocialLink>

              <SocialLink href="https://github.com/mesraiofficial" label="GitHub">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <SocialLink href="https://linkedin.com/company/mesrai" label="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd"/>
                </svg>
              </SocialLink>

              <SocialLink href="https://discordapp.com/users/1436265373757341699" label="Discord">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
